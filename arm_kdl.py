"""Official MMK2 ArmKdl source vendored for the formal Client.

Source: competition package ``examples/material_sorting/arm_kdl.py``.
Only packaging-level import placement differs from the supplied reference.
"""
